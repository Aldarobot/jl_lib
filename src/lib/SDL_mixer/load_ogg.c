...
#include "../SDL/header/SDL_mutex.h"
#include "../SDL/header/SDL_endian.h"
#include "../SDL/header/SDL_timer.h"
        ...
        SDL_AudioSpec *spec, Uint8 **audio_buf, Uint32 *audio_len)
{
    ...
    callbacks.seek_func = sdl_seek_func;//FIXME:AGH incompatible * type!
    callbacks.tell_func = sdl_tell_func;//FIXME:AGH incompatible * type!
    callbacks.close_func = freesrc ?//FIXME:AGH incompatible * type!
