...
#include "../SDL/header/SDL_stdinc.h"
#include "../SDL/header/SDL_rwops.h"
#include "../SDL/header/SDL_audio.h"
#include "../SDL/header/SDL_endian.h"
#include "../SDL/header/SDL_version.h"
#include "../SDL/header/begin_code.h"
...
#endif
#include "../SDL/header/close_code.h"
