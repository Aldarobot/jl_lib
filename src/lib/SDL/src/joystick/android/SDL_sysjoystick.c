...
#include "../../../header/SDL_error.h"
#include "../../../header/SDL_events.h"

#if !SDL_EVENTS_DISABLED
#include "../../events/SDL_events_c.h"
#endif

#include "../../../header/SDL_joystick.h"
#include "../../../header/SDL_hints.h"
#include "../../../header/SDL_assert.h"
#include "../../../header/SDL_timer.h"
#include "../../../header/SDL_log.h"
